...
class GomocuBtoB(Gomocu):
    def __init__(
        ...
        self.score = {self.bot1_path: 0, self.bot2_path: 0}
    ...
    def start_game(self):
        ...
        while True:
            ...
            if cw == -1:
                ...
                self.round += 1
                print(f"{bot_paths[self.player_turn-1]}, round: {self.round}")
                self.score[bot_paths[self.player_turn - 1]] += 1
                self.reset()
                break
